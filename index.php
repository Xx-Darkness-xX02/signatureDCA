...
<form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
    ...
    <input type="text" id="telefoonnummer" name="telefoonnummer" value="<?php if (!empty($telefoonnummer)) echo $telefoonnummer; ?>"/><br/>
    <label for="website">website:</label>
    <input type="text" id="website" name="website" value="<?php if (!empty($website)) echo $website; ?>"/><br/>
    <label for="twitter">twitter:</label>
    <input type="text" id="twitter" name="twitter" value="<?php if (!empty($twitter)) echo $twitter; ?>"/> *niet verplicht<br/>
    <label for="linkedin">linkedIN:</label>
    <input type="text" id="linkedin" name="linkedin" value="<?php if (!empty($linkedin)) echo $linkedin; ?>"/>*niet verplicht<br/>
    <label for="logo">kies een logo:</label>
    <input type="number" id="logo" name="logo" value="<?php if (!empty($logo)) echo $logo; ?>" <br /><br />
    <label for="social">social media iconen: </label>
    <input type="radio" id="social" name="social" value="yes">ja
    <input type="radio" id="social" name="social" value="nee">nee<br />
    <label for="element1">disclaimer:</label>
    <input type="text" id="element1" name="element1" value="<?php if (!empty($element1)) echo $element1; ?>"/> *niet verplicht <br />
    <label for="element2">andere info:</label>
    <input type="text" id="element2" name="element2" value="<?php if (!empty($element2)) echo $element2; ?>"/> *niet verplicht <br />
    <hr/>
